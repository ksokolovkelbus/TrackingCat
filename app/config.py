...
def _build_app_config(data: Mapping[str, Any]) -> AppConfig:
    ...
    return AppConfig(
        ...
        pan_tilt=PanTiltControlConfig(
            ...
            calibration_artifact_path=str(pan_tilt_data.get("calibration_artifact_path", defaults.pan_tilt.calibration_artifact_path)),
            auto_calibration_enabled=bool(pan_tilt_data.get("auto_calibration_enabled", defaults.pan_tilt.auto_calibration_enabled)),
            auto_calibration_grid_cols=int(pan_tilt_data.get("auto_calibration_grid_cols", defaults.pan_tilt.auto_calibration_grid_cols)),
            auto_calibration_grid_rows=int(pan_tilt_data.get("auto_calibration_grid_rows", defaults.pan_tilt.auto_calibration_grid_rows)),
            auto_calibration_pan_min_angle=float(pan_tilt_data.get("auto_calibration_pan_min_angle", defaults.pan_tilt.auto_calibration_pan_min_angle)),
            auto_calibration_pan_max_angle=float(pan_tilt_data.get("auto_calibration_pan_max_angle", defaults.pan_tilt.auto_calibration_pan_max_angle)),
            auto_calibration_tilt_min_angle=float(pan_tilt_data.get("auto_calibration_tilt_min_angle", defaults.pan_tilt.auto_calibration_tilt_min_angle)),
            auto_calibration_tilt_max_angle=float(pan_tilt_data.get("auto_calibration_tilt_max_angle", defaults.pan_tilt.auto_calibration_tilt_max_angle)),
            auto_calibration_local_pan_step_degrees=float(pan_tilt_data.get("auto_calibration_local_pan_step_degrees", defaults.pan_tilt.auto_calibration_local_pan_step_degrees)),
            auto_calibration_local_tilt_step_degrees=float(pan_tilt_data.get("auto_calibration_local_tilt_step_degrees", defaults.pan_tilt.auto_calibration_local_tilt_step_degrees)),
            auto_calibration_local_pan_points=int(pan_tilt_data.get("auto_calibration_local_pan_points", defaults.pan_tilt.auto_calibration_local_pan_points)),
            auto_calibration_local_tilt_points=int(pan_tilt_data.get("auto_calibration_local_tilt_points", defaults.pan_tilt.auto_calibration_local_tilt_points)),
            auto_calibration_settle_seconds=float(pan_tilt_data.get("auto_calibration_settle_seconds", defaults.pan_tilt.auto_calibration_settle_seconds)),
            auto_calibration_detection_timeout_seconds=float(pan_tilt_data.get("auto_calibration_detection_timeout_seconds", defaults.pan_tilt.auto_calibration_detection_timeout_seconds)),
            auto_calibration_confirm_frames=int(pan_tilt_data.get("auto_calibration_confirm_frames", defaults.pan_tilt.auto_calibration_confirm_frames)),
            auto_calibration_max_jump_px=float(pan_tilt_data.get("auto_calibration_max_jump_px", defaults.pan_tilt.auto_calibration_max_jump_px)),
            auto_calibration_reference_radius_tolerance=float(pan_tilt_data.get("auto_calibration_reference_radius_tolerance", defaults.pan_tilt.auto_calibration_reference_radius_tolerance)),
            auto_calibration_reference_area_tolerance=float(pan_tilt_data.get("auto_calibration_reference_area_tolerance", defaults.pan_tilt.auto_calibration_reference_area_tolerance)),
            auto_calibration_max_fit_error_degrees=float(pan_tilt_data.get("auto_calibration_max_fit_error_degrees", defaults.pan_tilt.auto_calibration_max_fit_error_degrees)),
            auto_calibration_min_samples=int(pan_tilt_data.get("auto_calibration_min_samples", defaults.pan_tilt.auto_calibration_min_samples)),
            auto_aim_enabled=bool(pan_tilt_data.get("auto_aim_enabled", defaults.pan_tilt.auto_aim_enabled)),
            auto_aim_interval_seconds=float(pan_tilt_data.get("auto_aim_interval_seconds", defaults.pan_tilt.auto_aim_interval_seconds)),
            auto_aim_only_when_laser_on=bool(pan_tilt_data.get("auto_aim_only_when_laser_on", defaults.pan_tilt.auto_aim_only_when_laser_on)),
            laser_saturation_min=int(pan_tilt_data.get("laser_saturation_min", defaults.pan_tilt.laser_saturation_min)),
            laser_value_min=int(pan_tilt_data.get("laser_value_min", defaults.pan_tilt.laser_value_min)),
            laser_red_min=int(pan_tilt_data.get("laser_red_min", defaults.pan_tilt.laser_red_min)),
            laser_red_delta=int(pan_tilt_data.get("laser_red_delta", defaults.pan_tilt.laser_red_delta)),
            laser_peak_min_value=int(pan_tilt_data.get("laser_peak_min_value", defaults.pan_tilt.laser_peak_min_value)),
            laser_peak_threshold_ratio=float(pan_tilt_data.get("laser_peak_threshold_ratio", defaults.pan_tilt.laser_peak_threshold_ratio)),
            laser_peak_window_radius_px=int(pan_tilt_data.get("laser_peak_window_radius_px", defaults.pan_tilt.laser_peak_window_radius_px)),
            laser_min_area_px=float(pan_tilt_data.get("laser_min_area_px", defaults.pan_tilt.laser_min_area_px)),
            laser_max_area_px=float(pan_tilt_data.get("laser_max_area_px", defaults.pan_tilt.laser_max_area_px)),
        ),
        output=OutputConfig(
